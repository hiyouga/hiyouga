...
1. Xiaohui Guo, Richong Zhang, **Yaowei Zheng**, Yongyi Mao: Robust Regularization with Adversarial Labelling of Perturbed Samples. **IJCAI2021**.
1. **Yaowei Zheng**, Richong Zhang and Yongyi Mao: Regularizing Neural Networks via Adversarial Model Perturbation. **CVPR2021**. [[arXiv]](https://arxiv.org/abs/2010.04925)[[Code]](https://github.com/hiyouga/AMP-Regularizer)
